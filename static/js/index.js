...
function websdkready() {
  ...
  var API_KEY = "TLkT5s84SRK4YdnoRByuow";
   ...
   */
  var API_SECRET = "N5lr9nz5G8aGNKWWwtstbviiZAUmCUfUHSo0";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "http://127.0.0.1:8000/meeting?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
